...
class blade_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Blade Rx", catch_exceptions=True)
        ...
        self._rx_gain_range = Range(-1, 60, 1, 40, 200)
        ...
        for c in range(0, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._tx_gain_range = Range(17, 73, 1, 50, 200)
        ...
        self.soapy_bladerf_source_0.set_frequency(0, (band * 1e6 + 100000 - offset) * (1 + correction*1e-6))
        self.soapy_bladerf_source_0.set_frequency_correction(0, 0)
        self.soapy_bladerf_source_0.set_gain(0, min(max(rx_gain, -1.0), 60.0))
        ...
        self.connect((self.soapy_bladerf_source_0, 0), (self.freq_xlating_fft_filter_ccc_0, 0))
    ...
    def set_rx_gain(self, rx_gain):
        ...
        self.soapy_bladerf_source_0.set_gain(0, min(max(self.rx_gain, -1.0), 60.0))
    ...
    def set_offset(self, offset):
        ...
        self.soapy_bladerf_source_0.set_frequency(0, (self.band * 1e6 + 100000 - self.offset) * (1 + self.correction*1e-6))
