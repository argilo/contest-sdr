...
class pluto_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Pluto Rx", catch_exceptions=True)
        ...
        self.soapy_plutosdr_source_0.set_frequency(0, (band * 1e6 + 100000 - offset) * (1 + correction*1e-6))
        ...
        self.connect((self.soapy_plutosdr_source_0, 0), (self.freq_xlating_fft_filter_ccc_0, 0))
    ...
    def set_offset(self, offset):
        ...
        self.soapy_plutosdr_source_0.set_frequency(0, (self.band * 1e6 + 100000 - self.offset) * (1 + self.correction*1e-6))
