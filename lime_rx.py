...
class lime_rx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lime Rx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lime Rx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lime_rx")
        ...
        self._rx_gain_range = Range(-12, 61, 1, 40, 200)
        ...
        self.soapy_limesdr_source_0.set_frequency(0, (band * 1e6 + 100000 - offset) * (1 + correction*1e-6))
        self.soapy_limesdr_source_0.set_frequency_correction(0, 0)
        self.soapy_limesdr_source_0.set_gain(0, min(max(rx_gain, -12.0), 61.0))
        ...
        self.connect((self.soapy_limesdr_source_0, 0), (self.freq_xlating_fft_filter_ccc_0, 0))
    ...
    def set_rx_gain(self, rx_gain):
        ...
        self.soapy_limesdr_source_0.set_gain(0, min(max(self.rx_gain, -12.0), 61.0))
    ...
    def set_offset(self, offset):
        ...
        self.soapy_limesdr_source_0.set_frequency(0, (self.band * 1e6 + 100000 - self.offset) * (1 + self.correction*1e-6))
...
def main(top_block_cls=lime_rx, options=None):
