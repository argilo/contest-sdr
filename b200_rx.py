...
class b200_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "B200 Rx", catch_exceptions=True)
        ...
        self.uhd_usrp_source_0.set_center_freq((band * 1e6 + 100000 - offset) * (1 + correction*1e-6), 0)
    ...
    def set_offset(self, offset):
        ...
        self.uhd_usrp_source_0.set_center_freq((self.band * 1e6 + 100000 - self.offset) * (1 + self.correction*1e-6), 0)
